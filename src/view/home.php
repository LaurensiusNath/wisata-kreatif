    ...
    <section id="default-carousel" class="relative w-full bg-slate-200 min-h-screen" data-carousel="slide">
        ...
        <div class="relative min-h-screen overflow-hidden rounded-lg md:h-96">
            ...
            <div class="hidden min-h-screen duration-700 ease-in-out" data-carousel-item>
                <img src="/wisata-kreatif-main/public/assets/labuan-bajo-header.jpg" class="object-cover object-center absolute z-10 block w-full min-h-screen -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            ...
            <!-- Item 2 -->
            <div class="hidden min-h-screen duration-700 ease-in-out" data-carousel-item>
                <img src="/wisata-kreatif-main/public/assets/raja-ampat-header.jpg" class="object-cover object-center absolute z-10 block w-full min-h-screen -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                <div class="relative min-h-screen flex flex-col justify-center items-center z-20 py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
            ...
            <!-- Item 3 -->
            <div class="hidden min-h-screen duration-700 ease-in-out" data-carousel-item>
                <img src="/wisata-kreatif-main/public/assets/nusa-header.jpg" class="object-cover object-center absolute z-10 block w-full min-h-screen -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                <div class="relative min-h-screen flex flex-col justify-center items-center z-20 py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                    <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-slate-50 md:text-5xl lg:text-6xl">Wisata Kreatif Indonesia</h1>
                    <p class="mb-8 text-lg font-normal text-slate-50 lg:text-xl sm:px-16 lg:px-48">Menemukan dan Mendukung Destinasi Wisata serta Produk Kreatif Lokal</p>
                    <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
            ...
            <!-- Item 4 -->
            <div class="hidden min-h-screen duration-700 ease-in-out" data-carousel-item>
                <img src="/wisata-kreatif-main/public/assets/bromo-header.jpg" class="object-cover object-center absolute z-10 block w-full min-h-screen -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                <div class="relative min-h-screen flex flex-col justify-center items-center z-20 py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                    <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-slate-50 md:text-5xl lg:text-6xl">Wisata Kreatif Indonesia</h1>
                    <p class="mb-8 text-lg font-normal text-slate-50 lg:text-xl sm:px-16 lg:px-48">Menemukan dan Mendukung Destinasi Wisata serta Produk Kreatif Lokal</p>
                    <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
